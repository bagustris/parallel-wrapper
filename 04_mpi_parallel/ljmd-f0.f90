...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! include MPI API Fortran 77 header file here  !
...
!!!!!MPI!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!! clear temporary force storage instead here
  frc(:,:) = 0.0_dbl
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
!! accumulate forces into temporary arrays instead
           frc(i,:) = frc(i,:) + delta*ffac
           frc(j,:) = frc(j,:) - delta*ffac
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        END IF
     END DO
  END DO
...
!  ! broadcast info to all nodes. uncomment for MPI version

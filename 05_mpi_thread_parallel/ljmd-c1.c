 ...
 * regular optimized code including newton's 3rd law.
 */
...
#pragma omp parallel reduction(+:epot)
#endif
    {
        ...
        for(ii=0; ii < (sys->natoms-1); ii += incr) {
            int i,j;
            double rx1, ry1, rz1;

            i = ii + sys->mpirank * sys->nthreads + tid;

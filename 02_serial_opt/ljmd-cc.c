 ...
 * optimization 7: don't update the cell lists every step.
 * optimization 8: use per loop local variables and  __attribute__(( )) 
 *                 directives to help the compiler to do the best job.
 * optimization 9: combine x-,y-,z-arrays into one array for better
